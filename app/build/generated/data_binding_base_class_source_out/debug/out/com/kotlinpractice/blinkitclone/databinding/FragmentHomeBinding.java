...
package com.kotlinpractice.blinkitclone.databinding;
...
public final class FragmentHomeBinding implements ViewBinding {
  ...
  private FragmentHomeBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnRetry,
      @NonNull ConstraintLayout errorLayout, @NonNull TextView errorText,
  ...
  public static FragmentHomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentHomeBinding((ConstraintLayout) rootView, btnRetry, errorLayout, errorText,
